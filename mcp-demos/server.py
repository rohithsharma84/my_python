...
@mcp.tool(annotations={"title": "Company Overview", "description": "Get a company overview with headquarters, products, business model, and recent news."}, description="Get a company overview with headquarters, products, business model, and recent news.")
...
@mcp.tool(annotations={"title": "List Competitors", "description": "List main direct and emerging competitors for a company, optionally filtered by category and region."}, description="List main direct and emerging competitors for a company, optionally filtered by category and region.")
...
@mcp.tool(annotations={"title": "Product Portfolio Map", "description": "Map a company's product portfolio, including suites, tiers, and product segments."}, description="Map a company's product portfolio, including suites, tiers, and product segments.")
...
@mcp.tool(annotations={"title": "Pricing Snapshot", "description": "Collect pricing, tier, billing, and discount information for a company or product."}, description="Collect pricing, tier, billing, and discount information for a company or product.")
...
@mcp.tool(annotations={"title": "Recent News Pulse", "description": "Summarize recent news, funding, acquisitions, launches, and leadership updates."}, description="Summarize recent news, funding, acquisitions, launches, and leadership updates.")
